    ...
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden border-b border-border px-6 py-20 md:py-32">
        ...
        <div className="relative mx-auto container text-center">
          ...
          <p className="mt-8 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground md:text-xl mx-auto">
            ...
            {ingenierias.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`
          ${idx === 0 ? "md:justify-self-start" : ""}
          ${idx === 1 ? "md:justify-self-center" : ""}
          ${idx === 2 ? "md:justify-self-end" : ""}
        `}
                >
                  <Card className="h-full max-w-md group relative overflow-hidden border-border bg-card transition-all duration-500 hover:shadow-2xl hover:shadow-epix-400/20 hover:-translate-y-2 w-full">
